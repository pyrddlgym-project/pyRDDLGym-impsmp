...
class MultivarNormalHKParametrization:
    ...
    Different parameterizations of the policy are possible (linear, MLP, ...).
    The parametrizations below are implemented using the dm-haiku library.
